...
public class Main {
    ...
    public static SequentialSearchST<String,SequentialSearchST<String,Double>> SSST;

    public static SequentialSearchST<String,Double> temp;
    ...
    public static void main(String[] args) {
        SSST = new SequentialSearchST<>();
        temp = new SequentialSearchST<>();
        ...
        SequentialSearchST<String,Double> temp2 = new SequentialSearchST<>();
        temp = new SequentialSearchST<>();
    ...
    public static double similarity(SequentialSearchST<String, SequentialSearchST<String, Double> > data, String person1, String person2){
        double distance = 0.0;
    ...
    public static double dist(SequentialSearchST<String, SequentialSearchST<String, Double> > data, String person1, String person2,String movie){
    ...
    public static String[] intersection (SequentialSearchST<String, SequentialSearchST<String, Double> > data, String person1, String person2) {
    ...
    public static double sim_pearson(SequentialSearchST<String,SequentialSearchST<String,Double>> mySSST, String person1,String person2) {
    ...
    public static double score(SequentialSearchST<String,SequentialSearchST<String,Double>> mySSST, String person,String movie) {
